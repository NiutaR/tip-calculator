...
//(TotalBillAmount * ServiceLevel)/NumberOfPersons 
function calcTip(billAmount, personSelected, selectedValue) {
    let tipAmount = (billAmount * selectedValue) / personSelected;
  ...
  function handleClick(event) {
    ...
    document.getElementById("result").innerHTML = "You should tip $" + calcTip(billAmount, personSelected, selectedValue);
  }
