...
function calculate() {
    let perc1 = document.getElementById('percent1').nodeValue;
    let NumberOfPersons = document.getElementById('person').nodeValue;
    const total = (TotalBillAmount * perc1) / NumberOfPersons;
    if(perc1 === value) {
...
document.getElementById('btn', oncl)