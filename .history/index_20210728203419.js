...
//(TotalBillAmount * ServiceLevel)/NumberOfPersons 
function calcTip(billAmount, personSelected, numberOfPersons) {
    let tipAmount = (billAmount * personSelected) / numberOfPersons;
  ...
  function handleClick(event) {
    ...
    let personSelected = percentageElement.options[percentageElement.selectedIndex].value;
    percentageSelected = personSelected;
    document.getElementById("result").innerHTML = "You should tip $" + calcTip(billAmount, percentageSelected, numberOfPersons);
  }
